...
def filldeck_random_60(regulation):
    ...
    if all_card_list:
        ...
        for i in range(60):
            ...
            Board_changer.Board().board_elem[Board_changer.Board().board_dic.index("DECK_0")].append(all_card_list[random_int])  # 指定ルール内のカードをランダムに加える
    print(Board_changer.Board().board_elem[Board_changer.Board().board_dic.index("DECK_0")])
    print(str(len(Board_changer.Board().board_elem[Board_changer.Board().board_dic.index("DECK_0")])) + "枚")
